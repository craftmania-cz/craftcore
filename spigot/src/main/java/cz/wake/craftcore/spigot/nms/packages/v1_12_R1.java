package cz.wake.craftcore.spigot.nms.packages;
...
public class v1_12_R1 implements NMSPackages {
    ...
    public void removeAdvancement(final cz.wake.craftcore.spigot.messages.Advancement advancement) {
