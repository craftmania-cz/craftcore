...
public class NBTCompound_v1_11_R1 extends NBTCompound {
    private NBTCompound decode(NBTTagCompound c){
        NBTCompound w = new NBTCompound_v1_11_R1();
        if (c != null) {
            for(Object o : c.c()){
                String s = o.toString();
    ...
    public NBTCompound_v1_11_R1() {
        super();
    }

    public NBTCompound_v1_11_R1(NBTTagCompound c){
    ...
    protected void fromEntity(Entity entity) {
        net.minecraft.server.v1_11_R1.Entity ce = ((CraftEntity) entity).getHandle();
