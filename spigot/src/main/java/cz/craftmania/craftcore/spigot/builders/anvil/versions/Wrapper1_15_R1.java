...
public class Wrapper1_15_R1 implements VersionWrapper {
    ...
    private final boolean IS_ONE_FIFTEEN = Bukkit.getBukkitVersion().contains("1.15");
    ...
    public int getNextContainerId(Player player, Object container) {
        if(IS_ONE_FIFTEEN) {
            return ((AnvilContainer1_15_R1) container).getContainerId();
        } else {
    ...
    public Object newContainerAnvil(Player player) {
        if (IS_ONE_FIFTEEN) {
            return new AnvilContainer1_15_R1(player, getRealNextContainerId(player));
        } else {
            return new Wrapper1_15_R1.AnvilContainer(player);
        }
    }
