package cz.craftmania.craftcore.spigot.builders.border;
...
public class CustomBorder {
    ...
    public CustomBorder(World world, double centerX, double centerZ, double radius) {
        super();
        this.world = world;
    ...
    public CustomBorder(World world, Location center, double radius) {
        super();
        this.world = world;
        this.worldBorder = world.getWorldBorder();
    ...
    public CustomBorder(World world, WorldBorder border) {
        super();
        this.world = world;
        this.worldBorder = world.getWorldBorder();
    ...
    public void moveWorldBorder(double newX, double newZ, double newRadius, int timeInSeconds, double damageAmount) {
        ...
        if (damageAmount != this.borderDamage) bs.runTaskLater(Main.getInstance(), () -> {
