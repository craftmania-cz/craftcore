...
public enum CustomMaterial {
   ...
   */
    ...
    LINGERING_POTION_AWKWARD(new CraftPotion(PotionBase.LINGERING, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "AWKWARD" : "WATER"), false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_FIRE_RESISTANCE_1(new CraftPotion(PotionBase.LINGERING, PotionType.FIRE_RESISTANCE, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_FIRE_RESISTANCE_2(new CraftPotion(PotionBase.LINGERING, PotionType.FIRE_RESISTANCE, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_HARMING_1(new CraftPotion(PotionBase.LINGERING, PotionType.INSTANT_DAMAGE, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_HARMING_2(new CraftPotion(PotionBase.LINGERING, PotionType.INSTANT_DAMAGE, false, true), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_HEALING_1(new CraftPotion(PotionBase.LINGERING, PotionType.INSTANT_HEAL, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_HEALING_2(new CraftPotion(PotionBase.LINGERING, PotionType.INSTANT_HEAL, false, true), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_INVISIBILITY_1(new CraftPotion(PotionBase.LINGERING, PotionType.INVISIBILITY, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_INVISIBILITY_2(new CraftPotion(PotionBase.LINGERING, PotionType.INVISIBILITY, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_LEAPING_1(new CraftPotion(PotionBase.LINGERING, PotionType.JUMP, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_LEAPING_2(new CraftPotion(PotionBase.LINGERING, PotionType.JUMP, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_LEAPING_3(new CraftPotion(PotionBase.LINGERING, PotionType.JUMP, false, true), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_LUCK(new CraftPotion(PotionBase.LINGERING, !Bukkit.getVersion().contains("1.8") ? PotionType.valueOf("LUCK") : PotionType.WATER, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_MUNDANE(new CraftPotion(PotionBase.LINGERING, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "MUNDANE" : "WATER"), false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_NIGHT_VISION_1(new CraftPotion(PotionBase.LINGERING, PotionType.NIGHT_VISION, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_NIGHT_VISION_2(new CraftPotion(PotionBase.LINGERING, PotionType.NIGHT_VISION, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_POISON_1(new CraftPotion(PotionBase.LINGERING, PotionType.POISON, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_POISON_2(new CraftPotion(PotionBase.LINGERING, PotionType.POISON, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_POISON_3(new CraftPotion(PotionBase.LINGERING, PotionType.POISON, false, true), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_REGENERATION_1(new CraftPotion(PotionBase.LINGERING, PotionType.REGEN, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_REGENERATION_2(new CraftPotion(PotionBase.LINGERING, PotionType.REGEN, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_REGENERATION_3(new CraftPotion(PotionBase.LINGERING, PotionType.REGEN, false, true), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_SLOW_FALLING_1(new CraftPotion(PotionBase.LINGERING, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_SLOW_FALLING_2(new CraftPotion(PotionBase.LINGERING, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_SLOWNESS_1(new CraftPotion(PotionBase.LINGERING, PotionType.SLOWNESS, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_SLOWNESS_2(new CraftPotion(PotionBase.LINGERING, PotionType.SLOWNESS, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_SLOWNESS_3(new CraftPotion(PotionBase.LINGERING, PotionType.SLOWNESS, false, true), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_STRENGTH_1(new CraftPotion(PotionBase.LINGERING, PotionType.STRENGTH, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_STRENGTH_2(new CraftPotion(PotionBase.LINGERING, PotionType.STRENGTH, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_STRENGTH_3(new CraftPotion(PotionBase.LINGERING, PotionType.STRENGTH, false, true), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_SWIFTNESS_1(new CraftPotion(PotionBase.LINGERING, PotionType.SPEED, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_SWIFTNESS_2(new CraftPotion(PotionBase.LINGERING, PotionType.SPEED, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_SWIFTNESS_3(new CraftPotion(PotionBase.LINGERING, PotionType.SPEED, false, true), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_THICK(new CraftPotion(PotionBase.LINGERING, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "THICK" : "WATER"), false, false), 0, null, "LINGERING_POTION"),
    ...
    LINGERING_POTION_TURTLE_MASTER_2(new CraftPotion(PotionBase.LINGERING, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER, true, false), 0, null, "LINGERING_POTION"),
    ...
    LINGERING_POTION_WATER(new CraftPotion(PotionBase.LINGERING, PotionType.WATER, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_WATER_BREATHING_1(new CraftPotion(PotionBase.LINGERING, PotionType.WATER_BREATHING, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_WATER_BREATHING_2(new CraftPotion(PotionBase.LINGERING, PotionType.WATER_BREATHING, true, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_WEAKNESS_1(new CraftPotion(PotionBase.LINGERING, PotionType.WEAKNESS, false, false), 0, null, "LINGERING_POTION"),
    LINGERING_POTION_WEAKNESS_2(new CraftPotion(PotionBase.LINGERING, PotionType.WEAKNESS, true, false), 0, null, "LINGERING_POTION"),
    ...
    POTION("POTION"),
    POTION_AWKWARD("POTION", !Bukkit.getVersion().contains("1.8") ? 0 : 16, new CraftPotion(PotionBase.NORMAL, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "AWKWARD" : "WATER"), false, false)),
    POTION_FIRE_RESISTANCE_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.FIRE_RESISTANCE, false, false)),
    POTION_FIRE_RESISTANCE_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.FIRE_RESISTANCE, true, false)),
    POTION_HARMING_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.INSTANT_DAMAGE, false, false)),
    POTION_HARMING_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.INSTANT_DAMAGE, false, true)),
    POTION_HEALING_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.INSTANT_HEAL, false, false)),
    POTION_HEALING_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.INSTANT_HEAL, false, true)),
    POTION_INVISIBILITY_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.INVISIBILITY, false, false)),
    POTION_INVISIBILITY_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.INVISIBILITY, true, false)),
    POTION_LEAPING_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.JUMP, false, false)),
    POTION_LEAPING_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.JUMP, true, false)),
    POTION_LEAPING_3("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.JUMP, false, true)),
    POTION_LUCK("POTION", 0, new CraftPotion(PotionBase.NORMAL, !Bukkit.getVersion().contains("1.8") ? PotionType.valueOf("LUCK") : PotionType.WATER, false, false)),
    POTION_MUNDANE("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "MUNDANE" : "WATER"), false, false)),
    POTION_NIGHT_VISION_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.NIGHT_VISION, false, false)),
    POTION_NIGHT_VISION_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.NIGHT_VISION, true, false)),
    POTION_POISON_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.POISON, false, false)),
    POTION_POISON_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.POISON, true, false)),
    POTION_POISON_3("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.POISON, false, true)),
    POTION_REGENERATION_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.REGEN, false, false)),
    POTION_REGENERATION_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.REGEN, true, false)),
    POTION_REGENERATION_3("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.REGEN, false, true)),
    POTION_SLOW_FALLING_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER, false, false)),
    POTION_SLOW_FALLING_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER, true, false)),
    POTION_SLOWNESS_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.SLOWNESS, false, false)),
    POTION_SLOWNESS_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.SLOWNESS, true, false)),
    POTION_SLOWNESS_3("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.SLOWNESS, false, true)),
    POTION_STRENGTH_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.STRENGTH, false, false)),
    POTION_STRENGTH_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.STRENGTH, true, false)),
    POTION_STRENGTH_3("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.STRENGTH, false, true)),
    POTION_SWIFTNESS_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.SPEED, false, false)),
    POTION_SWIFTNESS_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.SPEED, true, false)),
    POTION_SWIFTNESS_3("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.SPEED, false, true)),
    POTION_THICK("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "THICK" : "WATER"), false, false)),
    POTION_TURTLE_MASTER_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER, false, false)),
    POTION_TURTLE_MASTER_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER, true, false)),
    POTION_TURTLE_MASTER_3("POTION", 0, new CraftPotion(PotionBase.NORMAL, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER, false, true)),
    POTION_WATER("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.WATER, false, false)),
    POTION_WATER_BREATHING_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.WATER_BREATHING, false, false)),
    POTION_WATER_BREATHING_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.WATER_BREATHING, true, false)),
    POTION_WEAKNESS_1("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.WEAKNESS, false, false)),
    POTION_WEAKNESS_2("POTION", 0, new CraftPotion(PotionBase.NORMAL, PotionType.WEAKNESS, true, false)),
    ...
    SPLASH_POTION_AWKWARD(new CraftPotion(PotionBase.SPLASH, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "AWKWARD" : "WATER"), false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_FIRE_RESISTANCE_1(new CraftPotion(PotionBase.SPLASH, PotionType.FIRE_RESISTANCE, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_FIRE_RESISTANCE_2(new CraftPotion(PotionBase.SPLASH, PotionType.FIRE_RESISTANCE, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_HARMING_1(new CraftPotion(PotionBase.SPLASH, PotionType.INSTANT_DAMAGE, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_HARMING_2(new CraftPotion(PotionBase.SPLASH, PotionType.INSTANT_DAMAGE, false, true), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_HEALING_1(new CraftPotion(PotionBase.SPLASH, PotionType.INSTANT_HEAL, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_HEALING_2(new CraftPotion(PotionBase.SPLASH, PotionType.INSTANT_HEAL, false, true), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_INVISIBILITY_1(new CraftPotion(PotionBase.SPLASH, PotionType.INVISIBILITY, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_INVISIBILITY_2(new CraftPotion(PotionBase.SPLASH, PotionType.INVISIBILITY, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_LEAPING_1(new CraftPotion(PotionBase.SPLASH, PotionType.JUMP, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_LEAPING_2(new CraftPotion(PotionBase.SPLASH, PotionType.JUMP, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_LEAPING_3(new CraftPotion(PotionBase.SPLASH, PotionType.JUMP, false, true), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_LUCK(new CraftPotion(PotionBase.SPLASH, !Bukkit.getVersion().contains("1.8") ? PotionType.valueOf("LUCK") : PotionType.WATER, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_MUNDANE(new CraftPotion(PotionBase.SPLASH, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "MUNDANE" : "WATER"), false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_NIGHT_VISION_1(new CraftPotion(PotionBase.SPLASH, PotionType.NIGHT_VISION, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_NIGHT_VISION_2(new CraftPotion(PotionBase.SPLASH, PotionType.NIGHT_VISION, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_POISON_1(new CraftPotion(PotionBase.SPLASH, PotionType.POISON, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_POISON_2(new CraftPotion(PotionBase.SPLASH, PotionType.POISON, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_POISON_3(new CraftPotion(PotionBase.SPLASH, PotionType.POISON, false, true), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_REGENERATION_1(new CraftPotion(PotionBase.SPLASH, PotionType.REGEN, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_REGENERATION_2(new CraftPotion(PotionBase.SPLASH, PotionType.REGEN, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_REGENERATION_3(new CraftPotion(PotionBase.SPLASH, PotionType.REGEN, false, true), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_SLOW_FALLING_1(new CraftPotion(PotionBase.SPLASH, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_SLOW_FALLING_2(new CraftPotion(PotionBase.SPLASH, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_SLOWNESS_1(new CraftPotion(PotionBase.SPLASH, PotionType.SLOWNESS, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_SLOWNESS_2(new CraftPotion(PotionBase.SPLASH, PotionType.SLOWNESS, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_SLOWNESS_3(new CraftPotion(PotionBase.SPLASH, PotionType.SLOWNESS, false, true), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_STRENGTH_1(new CraftPotion(PotionBase.SPLASH, PotionType.STRENGTH, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_STRENGTH_2(new CraftPotion(PotionBase.SPLASH, PotionType.STRENGTH, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_STRENGTH_3(new CraftPotion(PotionBase.SPLASH, PotionType.STRENGTH, false, true), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_SWIFTNESS_1(new CraftPotion(PotionBase.SPLASH, PotionType.SPEED, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_SWIFTNESS_2(new CraftPotion(PotionBase.SPLASH, PotionType.SPEED, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_SWIFTNESS_3(new CraftPotion(PotionBase.SPLASH, PotionType.SPEED, false, true), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_THICK(new CraftPotion(PotionBase.SPLASH, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "THICK" : "WATER"), false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_TURTLE_MASTER_1(new CraftPotion(PotionBase.SPLASH, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_TURTLE_MASTER_2(new CraftPotion(PotionBase.SPLASH, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_TURTLE_MASTER_3(new CraftPotion(PotionBase.SPLASH, !Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER, false, true), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_WATER(new CraftPotion(PotionBase.SPLASH, PotionType.WATER, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_WATER_BREATHING_1(new CraftPotion(PotionBase.SPLASH, PotionType.WATER_BREATHING, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_WATER_BREATHING_2(new CraftPotion(PotionBase.SPLASH, PotionType.WATER_BREATHING, true, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_WEAKNESS_1(new CraftPotion(PotionBase.SPLASH, PotionType.WEAKNESS, false, false), 0, null, "SPLASH_POTION"),
    SPLASH_POTION_WEAKNESS_2(new CraftPotion(PotionBase.SPLASH, PotionType.WEAKNESS, true, false), 0, null, "SPLASH_POTION"),
    SPONGE("SPONGE"),
    ...
    TIPPED_ARROW_FIRE_RESISTANCE_1(new CraftPotion(PotionBase.ARROW, PotionType.FIRE_RESISTANCE, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_FIRE_RESISTANCE_2(new CraftPotion(PotionBase.ARROW, PotionType.FIRE_RESISTANCE, true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_HARMING_1(new CraftPotion(PotionBase.ARROW, PotionType.INSTANT_DAMAGE, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_HARMING_2(new CraftPotion(PotionBase.ARROW, PotionType.INSTANT_DAMAGE, false, true), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_HEALING_1(new CraftPotion(PotionBase.ARROW, PotionType.INSTANT_HEAL, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_HEALING_2(new CraftPotion(PotionBase.ARROW, PotionType.INSTANT_HEAL, false, true), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_INVISIBILITY_1(new CraftPotion(PotionBase.ARROW, PotionType.INVISIBILITY, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_INVISIBILITY_2(new CraftPotion(PotionBase.ARROW, PotionType.INVISIBILITY, true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_LEAPING_1(new CraftPotion(PotionBase.ARROW, PotionType.JUMP, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_LEAPING_2(new CraftPotion(PotionBase.ARROW, PotionType.JUMP, true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_LEAPING_3(new CraftPotion(PotionBase.ARROW, PotionType.JUMP, false, true), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_LUCK(new CraftPotion(PotionBase.ARROW, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "LUCK" : "JUMP"), false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_NIGHT_VISION_1(new CraftPotion(PotionBase.ARROW, PotionType.NIGHT_VISION, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_NIGHT_VISION_2(new CraftPotion(PotionBase.ARROW, PotionType.NIGHT_VISION, true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_POISON_1(new CraftPotion(PotionBase.ARROW, PotionType.POISON, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_POISON_2(new CraftPotion(PotionBase.ARROW, PotionType.POISON, false, true), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_REGENERATION_1(new CraftPotion(PotionBase.ARROW, PotionType.REGEN, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_REGENERATION_2(new CraftPotion(PotionBase.ARROW, PotionType.REGEN, true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_REGENERATION_3(new CraftPotion(PotionBase.ARROW, PotionType.REGEN, false, true), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SLOW_FALLING_1(new CraftPotion(PotionBase.ARROW, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? "SLOW_FALLING" : "SLOWNESS"), false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SLOW_FALLING_2(new CraftPotion(PotionBase.ARROW, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? "SLOW_FALLING" : "SLOWNESS"), true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SLOWNESS_1(new CraftPotion(PotionBase.ARROW, PotionType.SLOWNESS, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SLOWNESS_2(new CraftPotion(PotionBase.ARROW, PotionType.SLOWNESS, true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SLOWNESS_3(new CraftPotion(PotionBase.ARROW, PotionType.SLOWNESS, false, true), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_STRENGTH_1(new CraftPotion(PotionBase.ARROW, PotionType.STRENGTH, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_STRENGTH_2(new CraftPotion(PotionBase.ARROW, PotionType.STRENGTH, true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_STRENGTH_3(new CraftPotion(PotionBase.ARROW, PotionType.STRENGTH, false, true), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SWIFTNESS_1(new CraftPotion(PotionBase.ARROW, PotionType.SPEED, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SWIFTNESS_2(new CraftPotion(PotionBase.ARROW, PotionType.SPEED, true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_SWIFTNESS_3(new CraftPotion(PotionBase.ARROW, PotionType.SPEED, false, true), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_TURTLE_MASTER_1(new CraftPotion(PotionBase.ARROW, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? "TURTLE_MASTER" : "SLOWNESS"), false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_TURTLE_MASTER_2(new CraftPotion(PotionBase.ARROW, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? "TURTLE_MASTER" : "SLOWNESS"), true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_TURTLE_MASTER_3(new CraftPotion(PotionBase.ARROW, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9") && !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11") && !Bukkit.getVersion().contains("1.12") ? "TURTLE_MASTER" : "SLOWNESS"), false, true), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_WATER_BREATHING_1(new CraftPotion(PotionBase.ARROW, PotionType.WATER_BREATHING, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_WATER_BREATHING_2(new CraftPotion(PotionBase.ARROW, PotionType.WATER_BREATHING, true, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_WEAKNESS_1(new CraftPotion(PotionBase.ARROW, PotionType.WEAKNESS, false, false), 0, "ARROW", "TIPPED_ARROW"),
    TIPPED_ARROW_WEAKNESS_2(new CraftPotion(PotionBase.ARROW, PotionType.WEAKNESS, true, false), 0, "ARROW", "TIPPED_ARROW"),
    TNT("TNT"),
    ...
    private static final HashMap<String, CustomMaterial> inUMemory = new HashMap<>();
    ...
    CustomMaterial(String... names) {
        this(0, names);
    }

    CustomMaterial(String name, int data) {
        names[0] = name;
        this.data = data;
    ...
    CustomMaterial(String name, int spoofedData, Color color) {
        names[0] = name;
    ...
    CustomMaterial(String name, int data, CraftPotion pd) {
        doPotion(setItemStack(name, data), pd);
    }

    CustomMaterial(CraftPotion pd, int data, String... names) {
        doPotion(setItemStack(data, names), pd);
    }

    CustomMaterial(String name, Enchantment enchant, int level) {
        doEnchantmentBook(setItemStack(0, name), enchant, level);
    }

    CustomMaterial(int data, String... names) {
        this.names = names;
        this.data = data;
    ...
    private void doPotion(ItemStack m, CraftPotion up) {
    ...
    @Deprecated
    public static CustomMaterial matchUMaterial(String name, byte data) {
        name = name.toUpperCase();
        if (inUMemory.keySet().contains(name + data)) return inUMemory.get(name + data);
        for (CustomMaterial u : CustomMaterial.values()) {
...
class CraftPotion {
    ...
    public CraftPotion(CustomMaterial.PotionBase base, PotionType type, boolean extended, boolean upgraded) {
        if (v.contains("1.8")) {
