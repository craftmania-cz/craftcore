...
public class TinyProtocol {
    ...
    private static final CustomReflection.MethodInvoker getPlayerHandle = CustomReflection.getMethod("{obc}.entity.CraftPlayer", "getHandle");
    private static final CustomReflection.FieldAccessor<Object> getConnection = CustomReflection.getField("{nms}.EntityPlayer", "playerConnection", Object.class);
    private static final CustomReflection.FieldAccessor<Object> getManager = CustomReflection.getField("{nms}.PlayerConnection", "networkManager", Object.class);
    private static final CustomReflection.FieldAccessor<Channel> getChannel = CustomReflection.getField("{nms}.NetworkManager", Channel.class, 0);

    // Looking up ServerConnection
    private static final Class<Object> minecraftServerClass = CustomReflection.getUntypedClass("{nms}.MinecraftServer");
    private static final Class<Object> serverConnectionClass = CustomReflection.getUntypedClass("{nms}.ServerConnection");
    private static final CustomReflection.FieldAccessor<Object> getMinecraftServer = CustomReflection.getField("{obc}.CraftServer", minecraftServerClass, 0);
    private static final CustomReflection.FieldAccessor<Object> getServerConnection = CustomReflection.getField(minecraftServerClass, serverConnectionClass, 0);
    private static final CustomReflection.MethodInvoker getNetworkMarkers = CustomReflection.getTypedMethod(serverConnectionClass, null, List.class, serverConnectionClass);

    // Packets we have to intercept
    private static final Class<?> PACKET_LOGIN_IN_START = CustomReflection.getMinecraftClass("PacketLoginInStart");
    private static final CustomReflection.FieldAccessor<GameProfile> getGameProfile = CustomReflection.getField(PACKET_LOGIN_IN_START, GameProfile.class, 0);
    ...
    private void registerChannelHandler() {
        ...
        for (int i = 0; looking; i++) {
            List<Object> list = CustomReflection.getField(serverConnection.getClass(), List.class, i).get(serverConnection);
