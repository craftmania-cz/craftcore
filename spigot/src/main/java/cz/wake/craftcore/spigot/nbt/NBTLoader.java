package cz.wake.craftcore.spigot.nbt;
...
/**
 * A class helps you to load NBT tags
 */
public class NBTLoader {
    ...
    public static NBTCompound create(){
        try {
            Class<?> e = Class.forName("cz.wake.craftcore.nbt.versions.NBTCompound_" +
                    NMSManager.getVersion());
    ...
    public static NBTCompound fromJSON(String json){
        ...
        return handlejo(create(), new Gson().fromJson(json, new TypeToken<JsonObject>(){}.getType()));
    }
    ...
    private static Object handlejoe(JsonElement e) {
        ...
        if(e.isJsonPrimitive()){
            ...
            value = handlejo(create(), e.getAsJsonObject());
        }
        return value;
    }
}
