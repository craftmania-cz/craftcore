package cz.craftmania.craftcore.spigot.utils.mojang;
...
import cz.craftmania.craftcore.core.utils.time.TimeUnit;
...
public class SkinAPI {
    ...
    public SkinAPI() {
        try {
            ...
            for(File file : Main.SKINS_FOLDER.listFiles((dir, name) -> name.endsWith(".skin"))) {
    ...
    public static File getSkinFile(CachedSkin skin) {
        return new File(Main.SKINS_FOLDER, skin.getOwner().toString()+".skin");
    }
}
